  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Discover the story behind Restaurant Name — where passion for food, elegant ambiance, and exceptional service come together to create a memorable dining experience."
        />
      </Helmet>
            ...
            >
              ...
              <div className="space-y-4 md:space-y-6 text-sm md:text-base text-gray-400 font-light leading-relaxed md:leading-loose max-w-2xl mx-auto lg:mx-0">
                <p>
                  ...
                  restaurant has been a beacon of culinary innovation for over
                  two decades. Every ingredient has a soul, and our mission is
                  to bring that to your plate with precision.
                </p>
